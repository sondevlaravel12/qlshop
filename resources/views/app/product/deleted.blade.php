                        ...
                        <tr>
                            ...
                            <td>
                                {{-- <form action="{{route('products.restore')}}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-link" ><i class="fas fa-trash-restore"></i></button>
                                </form> --}}
                                <form action="{{route('products.restore', $product)}}" method="GET">
                                    @method('GET')
                                    <button type="submit" class="btn btn-sm btn-link" ><i class="fas fa-trash-restore"> Khôi phục</i></button>
                                </form>
                            </td>
